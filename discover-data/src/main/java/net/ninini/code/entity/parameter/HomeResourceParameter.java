...
public class HomeResourceParameter {


    public HomeResourceParameter() {

    }

    public THomeResourceExample getExample() {
        THomeResourceExample example = new THomeResourceExample();
        THomeResourceExample.Criteria criteria = example.createCriteria();
